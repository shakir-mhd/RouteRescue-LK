...
export default function SuperAdminDashboard() {
  ...
  // Active Tab View State: 'analytics' | 'live-incidents' | 'completed-history' | 'queue' | 'directory' | 'billing' | 'map' | 'settings'
  const [activeTab, setActiveTab] = useState<'analytics' | 'live-incidents' | 'completed-history' | 'queue' | 'directory' | 'billing' | 'map' | 'settings'>('analytics');
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 text-slate-100 flex flex-col px-4 py-6 relative overflow-x-hidden select-none">
      ...
      <main className="max-w-5xl w-full mx-auto flex-grow flex flex-col gap-6">
        {/* Navigation Bar - Super Admin Tabs */}
